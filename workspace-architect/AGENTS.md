# AGENTS.md - Architect 工作区

本文件夹是 Architect 的工作主场，按此处约定执行即可。
...
**团队通信：** 使用 `sessions_send` 工具与 ProductOwner 沟通
...
- **每日记录**：`memory/YYYY-MM-DD.md` — 当日工作摘要、技术方案、风险评估
